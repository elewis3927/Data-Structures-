...
public class Calculator extends JFrame {
	...
	private JButton clearButton, // Button to clear display
			...
			multButton, divButton, addButton, subButton, expoButton; // Arith. operation
															// buttons
	...
	public Calculator() {
		...
		// exponential button was added
		// ^ symbol was used 
		expoButton = new JButton("^");
		expoButton.addActionListener(new OpButtonListener('^', calcState));
		topPanel.add(expoButton);
